      ...
      <div className='single-main'>
        ...
        <div className='sin-right'>
          ...
          <div className='card'>
            ...
            <div className='card-all'>
              <div className='card-img'>
                <img src='https://assets.tatacliq.com/medias/sys_master/images/46494116380702.png' />
              </div>
              <div className='card-info'>
                <h6>Flat 5% off on all UPI transactions.</h6>
                <p>Min Purchase: ₹1500 | Max Discount: ₹200 <span>more</span></p>
              </div>
            </div>
            <div className='card-all'>
              <div className='card-img'>
              ...
              <div className='card-info'>
                <h6>Flat Rs 200 off. Valid on the app only.</h6>
                <p>Use Code: FIRSTCLIQ | Min Purchase: ₹1200 <span>more</span></p>
              </div>
            </div>
